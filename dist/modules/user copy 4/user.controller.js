...
router.patch("/upload-profile-image", auth_middleware_1.auth, (0, multer_upload_1.multerUpload)({ storeIn: multer_types_1.StoreInEnum.MEMORY }).single("profileImage"), userService.uploadProfileImage);
router.patch("/upload-profile-video", auth_middleware_1.auth, (0, multer_upload_1.multerUpload)({
    sendedFileType: multer_types_1.FileType.video,
    storeIn: multer_types_1.StoreInEnum.DISK,
}).single("profileVideo"), userService.uploadProfileVideo);
...
router.patch("/upload-cover-images", auth_middleware_1.auth, (0, multer_upload_1.multerUpload)({ storeIn: multer_types_1.StoreInEnum.MEMORY }).array("coverImages", 3), userService.uploadCoverImages);
