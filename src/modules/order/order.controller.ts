...
import { getOrderSchema, deleteOrderSchema } from "./order.validation";

const router = Router();
const orderService = new OrderService();

router.post("/add-order", auth, orderService.addOrder);
...
router.patch("/update-order", auth, orderService.updateOrder);
